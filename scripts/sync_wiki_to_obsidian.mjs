...
const titleMap = {
    ...
    'context-coordination-layer.md': 'Context And Coordination Layer',
    'current-product-map.md': 'Current Product Map',
    'decision-reason-mapper.md': 'Decision Reason Mapper',
    'evolution-control-plane.md': 'Evolution Control Plane',
    'language-guide.md': 'Language Guide',
    'memory-skill-layer.md': 'Memory Skill Layer',
    ...
    'synthetic-continuity-boundary.md': 'Synthetic Continuity Boundary',
