...
const requiredTerms = [
    ...
    { pattern: /Six quick choices\. Better answers\./i, label: 'setup: plain promise' },
    { pattern: /What are you bringing first\?/i, label: 'setup: entry question' },
    { pattern: /What do you want from the first answer\?/i, label: 'setup: first-answer question' },
    { pattern: /What should it avoid\?/i, label: 'setup: boundary question' },
    { pattern: /Save and reflect/i, label: 'setup: explicit save' },
    { pattern: /Saved in this browser/i, label: 'setup: saved confirmation' },
    { pattern: /Download Mirror ID/i, label: 'setup: portable download' },
